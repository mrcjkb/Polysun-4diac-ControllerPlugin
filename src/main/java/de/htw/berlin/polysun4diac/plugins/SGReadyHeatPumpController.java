 ...
 * This plugin controller is used to overload the control signal of a heating controller. It must be placed after the heating controller.
 * 
...
public class SGReadyHeatPumpController extends AbstractSingleComponentController {
	 ...
	 */
	private float[] mSGReadyMode1 = {0.0f, 0.0f};
	/** 
	 ...
	 *  - auxiliary heater: off
	 */
	private float[] mSGReadyMode2 = {1.0f, 0.0f};
	/** 
	 ...
	 * Default Polysun setting for this mode:</p>
	 *  - heat pump: What was set by the Polysun heater controller </p>
	 * 	- control mode: 0 (maximum power)</p>
	 *  - auxiliary heater: off
	 */
	private float[] mSGReadyMode3 = {1.0f, 0.0f};
	/** 
	 ...
	 *  - auxiliary heater: on
	 */
	private float[] mSGReadyMode4 = {1.0f, 1.0f};
	/**
	...
	public void initialiseSimulation(Map<String, Object> parameters) throws PluginControllerException {
		...
		if (getProperty(HEATING_ELEMENT3_KEY).getInt() == HAS_NO_HEATING_ELEMENT) {
			mSGReadyMode3[1] = 0.0f; // Disable auxiliary heater for mode 3.
		} else {
			mSGReadyMode3[1] = 1.0f; // Enable auxiliary heater for mode 3.
		}
		if (getProperty(HEATING_ELEMENT4_KEY).getInt() == HAS_NO_HEATING_ELEMENT) {
			mSGReadyMode4[1] = 0.0f; // Disable auxiliary heater for mode 4.
		} else {
			mSGReadyMode4[1] = 1.0f; // Enable auxiliary heater for mode 4.
		}
