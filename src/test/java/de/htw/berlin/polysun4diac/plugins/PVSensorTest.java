...
public class PVSensorTest {
	...
	private static final String NAME = "Photovoltaics Sensor";
	...
	private PolysunSettings createPolysunSettings(String host, int port,
			int timestampSetting, int waitForRsp, boolean measuredPVpower, boolean feedInLimit, boolean sendTimestamp) {
		...
		sensors.add(new Sensor(SENSOR1, "W", true, false, measuredPVpower)); // Sensor 1
		sensors.add(new Sensor(SENSOR2, "", true, false, feedInLimit)); // Sensor 2
	...
	public void setUp() throws Exception {
		controller = new PVSensorController();
