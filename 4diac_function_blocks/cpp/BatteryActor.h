...
#ifndef _BATTERYACTOR_H_
#define _BATTERYACTOR_H_
...
class FORTE_BatteryActor: public CCompositeFB{
  DECLARE_FIRMWARE_FB(FORTE_BatteryActor)
...
public:
  COMPOSITE_FUNCTION_BLOCK_CTOR(FORTE_BatteryActor){
  };

  virtual ~FORTE_BatteryActor(){};
