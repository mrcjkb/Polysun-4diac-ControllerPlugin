...
const SCFB_FBInstanceData FORTE_PVActor::scm_astInternalFBs[] = {
  ...
  {g_nStringIdLREAL2LREAL, g_nStringIdLREAL2LREAL},
};
...
const SCFB_FBConnectionData FORTE_PVActor::scm_astEventConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdRSP), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdLREAL2LREAL, g_nStringIdREQ), 1},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdLREAL2LREAL, g_nStringIdCNF), 1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdSERVER_1, g_nStringIdRSP), 0},
};
...
const SCFB_FBConnectionData FORTE_PVActor::scm_astDataConnections[] = {
  ...
  {GENERATE_CONNECTION_PORT_ID_1_ARG(g_nStringIdDF), -1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdLREAL2LREAL, g_nStringIdIN), 1},
  {GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdLREAL2LREAL, g_nStringIdOUT), 1, GENERATE_CONNECTION_PORT_ID_2_ARG(g_nStringIdSERVER_1, g_nStringIdSD_1), 0},
};
